      ...
      {kind === "text" ? (
        <div>
          <input
            ...
            {...register}
            type={type}
            className="focus:border-pruple-500 w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:outline-none focus:ring-purple-500"
          />
        </div>
      ) : null}
      {kind === "price" ? (
